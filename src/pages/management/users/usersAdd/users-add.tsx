...
import { useAddUser } from "@/query/useUserManagement";
import {
  addUserSchema,
...
const UsersAdd = () => {
  ...
  const { mutate: addUserMutation, isPending: addUserPending } = useAddUser();
      ...
      <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create a new user within the organisation to grant system access and assign specific roles.
            </CardDescription>
          </CardHeader>
        ...
        <div className="flex justify-end items-center gap-3 pt-4 border-t border-border">
          ...
          <Button type="submit" disabled={addUserPending}>
            {addUserPending ? "Creating User..." : "Add User"}
          </Button>
        </div>
      </form>
    </div>
