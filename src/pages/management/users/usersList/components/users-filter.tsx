      ...
      <DrawerContent className="p-0">
        <DrawerHeader className="border-b border-border/40 pb-4">
          <DrawerTitle className="flex justify-between items-center px-4">
            <span className="text-lg font-bold">User Filters</span>
            <Button
              variant="ghost"
              size="icon"
          ...
          <DrawerDescription className="px-4">
            Filter users by role type or active status.
          </DrawerDescription>
        </DrawerHeader>
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="user-type">Role Type</Label>
            <SelectComponent
              id="user-type"
              placeholder="Select Role"
              data={UserTypeFilterData}
